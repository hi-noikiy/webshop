...
trait CreatesTestData
{
    ...
    protected function createCompany($params = [])
    {
        ...
        $company->street = isset($params['street']) ? $params['street'] : "Teststraat 1";
        $company->postcode = isset($params['postcode']) ? $params['postcode'] : "1337 XX";
        $company->city = isset($params['city']) ? $params['city'] : "Test stad";
        $company->email = isset($params['email']) ? $params['email'] : "test@example.com";
    ...
    /**
     * Create a test product description
     *
