...
<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#e4e4e4">
    <tr>
        <td bgcolor="#e4e4e4" width="100%">
                        ...
                        <table width="600" cellpadding="0" cellspacing="0" border="0" class="table">
                            <tr>
                                <td width="250" bgcolor="#e4e4e4" class="logocell">
                                    <img border="0" src="{{ $message->embed(public_path('vendor/beautymail/assets/images/widgets/spacer.gif')) }}" width="1" height="20" class="hide">
                                    <br class="hide">
                                    @if (isset($logo))
                                        <img src="{{ $message->embed($logo['path']) }}" width="{{ $logo['width'] }}" height="{{ $logo['height'] }}" alt="{{ $senderName or '' }}" style="-ms-interpolation-mode:bicubic;">
                                    @endif
                                    <br>
                                    <img border="0" src="{{ $message->embed(public_path('vendor/beautymail/assets/images/widgets/spacer.gif')) }}" width="1" height="10" class="hide"><br class="hide"></td>
                                <td align="right" width="350" class="hide" style="color:#a6a6a6;font-size:12px;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;text-shadow: 0 1px 0 #ffffff;" valign="top" bgcolor="#e4e4e4"><img border="0" src="{{ $message->embed(public_path('vendor/beautymail/assets/images/widgets/spacer.gif')) }}" width="1" height="63"><br></td>
                            </tr>
                        </table>

                        <img border="0" src="{{ $message->embed(public_path('vendor/beautymail/assets/images/widgets/spacer.gif')) }}" width="1" height="15" class="divider"><br>
            ...
            <img border="0" src="{{ $message->embed(public_path('vendor/beautymail/assets/images/widgets/spacer.gif')) }}" width="1" height="25" class="divider"><br>

            <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#f2f2f2">
                <tr>
                    <td>

                        <img border="0" src="{{ $message->embed(public_path('vendor/beautymail/assets/images/widgets/spacer.gif')) }}" width="1" height="30"><br>
                                    ...
                                    <table width="600" cellpadding="0" cellspacing="0" border="0" class="table">
                                        <tr>
                                            <td width="380" valign="top" class="footershow">
                                                ...
                                                <img border="0" src="{{ $message->embed(public_path('vendor/beautymail/assets/images/widgets/spacer.gif')) }} width="1" height="8"><br>
                                            ...
                                            <td align="right" width="220" style="color:#a6a6a6;font-size:12px;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;text-shadow: 0 1px 0 #ffffff;" valign="top" class="hide">
                                                ...
                                                <img border="0" src="{{ $message->embed(public_path('vendor/beautymail/assets/images/widgets/spacer.gif')) }}" width="1" height="10"><br><p style="color:#b3b3b3;font-size:11px;line-height:15px;font-family:Helvetica,Arial,sans-serif;margin-top:0;margin-bottom:0;padding-top:0;padding-bottom:0;font-weight:bold;">{{ $senderName or '' }}</p>
                        ...
                        <img border="0" src="{{ $message->embed(public_path('vendor/beautymail/assets/images/widgets/spacer.gif')) }}" width="1" height="25"><br>
