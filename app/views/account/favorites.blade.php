        ...
        <div class="row">
                ...
                <div class="col-md-9">
                        @if(count($favorites) === 0)
                                <div class="alert alert-warning text-center">U heeft nog geen favorieten toegevoegd. Favorieten kunnen toegevoegd worden door op de product pagina op de volgende knop te drukken: <button class="btn btn-danger" disabled><span class="glyphicon glyphicon-heart"></span></button></div>
                        @else
